...
import { setStudentList } from "../../../redux/slices/adminSlice";
...
export default function StudentPage() {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        const res = await axios.get(`${USER_API_ENDPOINT}/admin/all-students`, {
          withCredentials: true,
        });
        if (res.data.success) {
                    ...
                    >
                      ...
                      <td className="px-6 py-4 text-right">
                        <div className="flex items-center justify-end gap-2">
                          <button
                            onClick={() => setConfirmId(stu._id)}
                            disabled={loadingId === stu._id}
                          ...
                          >
                            ...
                            {loadingId === stu._id ? "Deleting…" : "Delete"}
                          </button>
                        </div>
                      </td>
                    </tr>
